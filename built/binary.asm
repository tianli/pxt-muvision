...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2096 (incl. 1392 user, 660 helpers, 12 vtables, 32 lits); src size 0
; assembly: 1369 lines; density: 696 bytes/stmt; (2 stmts)
; total bytes: 223280 (92.0% of 237.0k flash with 19408 free)
...
; start
    ...
    .hex 49DF32A3E1ADF2DC ; hex template hash
    .hex 79414FEE4C2A045B ; program hash
    .short 1   ; num. globals
